...
- `rpa-cli parse <project>` - Full project parsing with progress indication
- `rpa-cli list workflows|roots|orphans` - Rich table displays
- `rpa-cli help` - Comprehensive command documentation
- `rpa-cli --version` - Version information
