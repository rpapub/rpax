...
from rpax.pseudocode import PseudocodeArtifact, PseudocodeEntry, PseudocodeGenerator
...
class TestPseudocodeModels:
    ...
    def test_pseudocode_entry_creation(self):
        ...
        entry = PseudocodeEntry(
            ...
            tag="LogMessage",
            activity_path="Activity/Sequence/LogMessage",
            formatted_line="  - [Log Message INFO] LogMessage (ActivityPath: Activity/Sequence/LogMessage)",
        ...
        assert entry.activity_path == "Activity/Sequence/LogMessage"
            ...
            entries=[
                {
                    ...
                    "tag": "Sequence",
                    "activityPath": "Activity/Sequence",
                    "formattedLine": "- [Main Sequence] Sequence (ActivityPath: Activity/Sequence)",
                    "nodeId": "/Sequence[0]",
                    "depth": 0,
                    "isVisual": True,
                    "children": [],
...
class TestPseudocodeGenerator:
    ...
    def test_format_pseudocode_line_root(self):
        ...
        expected = "- [Main Process] Sequence (ActivityPath: Activity/Sequence)"
    ...
    def test_format_pseudocode_line_nested(self):
        ...
        expected = "  - [Log start message] LogMessage (ActivityPath: Activity/Sequence/LogMessage)"
    ...
    def test_format_pseudocode_line_deep_nested(self):
        ...
        expected = "      - [Set username] Assign (ActivityPath: Activity/Sequence/TryCatch/TryCatch.Try/Sequence/Assign)"
    ...
    def test_generate_workflow_pseudocode_success(self):
        ...
        assert (
            root_entry["formattedLine"]
            == "- [Main Sequence] Sequence (ActivityPath: Activity/Sequence)"
        )
        assert root_entry["indent"] == 0
        assert root_entry["activityPath"] == "Activity/Sequence"

        child_entry = result.entries[1]
        assert child_entry["displayName"] == "Log Message INFO begin"
        assert (
            child_entry["formattedLine"]
            == "  - [Log Message INFO begin] LogMessage (ActivityPath: Activity/Sequence/LogMessage)"
        )
    ...
    def test_render_as_text(self):
        ...
        artifact = PseudocodeArtifact(
            ...
            entries=[
                ...
                },
                {
                    ...
                    "tag": "LogMessage",
                    "activityPath": "Activity/Sequence/LogMessage",
                    "formattedLine": "  - [Log Message] LogMessage (ActivityPath: Activity/Sequence/LogMessage)",
        ...
        expected = (
            "- [Main Sequence] Sequence (ActivityPath: Activity/Sequence)\n"
            "  - [Log Message] LogMessage (ActivityPath: Activity/Sequence/LogMessage)"
        )
    ...
    def test_create_empty_artifact_with_error(self):
        ...
        result = self.generator._create_empty_artifact(
            "FailedWorkflow", error="Parse failed"
        )
    ...
    def test_serialize_entry(self):
        ...
        child_entry = PseudocodeEntry(
            ...
            display_name="Child",
            tag="Assign",
            activity_path="Activity/Sequence/Assign",
            formatted_line="    - [Child] Assign (ActivityPath: Activity/Sequence/Assign)",
        ...
        parent_entry = PseudocodeEntry(
            ...
            display_name="Parent",
            tag="Sequence",
            activity_path="Activity/Sequence",
            formatted_line="  - [Parent] Sequence (ActivityPath: Activity/Sequence)",
            node_id="/Sequence[0]",
            depth=1,
            is_visual=True,
        ...
        assert result["activityPath"] == "Activity/Sequence"
